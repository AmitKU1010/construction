              ...
              <div class="table-bootstrap">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ url('/')}}/admin/voucher-print/{{ $data['id'] }}" target="_blank"  class="btn btn-success btn-xs"><i class="fa fa-print"></i></a> 
                      <a href="{{ url('/')}}/admin/voucher-edit/{{ $data['id'] }}" class="btn btn-success btn-xs"><i class="fa fa-edit"></i></a> 
