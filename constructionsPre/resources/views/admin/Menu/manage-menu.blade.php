                  ...
                  <div class="col-lg-6 col-sm-6 col-xs-12">
                     <div class="widget flat radius-bordered">
                        <div class="widget-header bg-blue">
                           ...
                           @if(isset($id))
                           <a href="{{url('/manage/menu')}}" class="btn btn-success btn-xs margin-top-5 margin-right-5">Add Menu</a>
                           @endif
                        </div>
                        <div class="widget-body">
                           ...
                           <div id="registration-form">
                            ...
                            {{ Form::hidden('id', isset($id) ? $id :'', []) }}
                                ...
                                <div class="col-md-5">
                                     <div class="form-group">
                                        <label for="exampleInputEmail2">Choose Role for Assign</label>
                                        <span class="input-icon icon-right">
                                            {{Form::select('role_id[]', $roleList, isset($role_id) ? $role_id : '', ['class' => 'form-control', 'required', 'multiple'] )}}
                                        </span>
                                     </div>
                                </div>
                                 <div class="form-group">
                                 ...
                                 {{Form::submit(isset($id) ? 'Update Menu' : 'Add Menu', ['class' => 'btn btn-blue'])}}
                        ...
                        <div class="widget-body">
                           <div id="registration-form">
                              <table class="table table-bordered">
                                  ...
                                  <tbody>
                                      @if(isset($menuListAll) && count($menuListAll) > 0)
                                    @foreach($menuListAll as $menu)
                                      <tr>
                                          ...
                                          <td>
                                              ...
                                              <a href="{{url('/manage/menu/delete')}}/{{$menu['id']}}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete this item?');"><i class="glyphicon glyphicon-trash"></i></a>
                                          </td>
                                      </tr>
                                      @php $count++ @endphp
                                    @endforeach
