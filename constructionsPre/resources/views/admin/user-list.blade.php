...
<section class="content">
   <div class="box">
      ...
      <div class="box-body">
         ...
         @endif --}}
         {{ Form::open(['url' => 'admin/employee-list', 'files' => true]) }} 
         {{ csrf_field() }}
         ...
         <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     @if($user->role->id !== 1)
                     <a href="{{url('/')}}/admin/employee/{{ $user->id }}/view" class="btn btn-default btn-xs" title="View Details"><i class="fa fa-eye"></i></a> 
                     <a href="{{url('/')}}/admin/employee-edit/{{ $user->id }}" class="btn btn-success btn-xs" title="Edit Details"><i class="fa fa-edit"></i></a> 
                     <a href="{{url('/')}}/admin/employee/trash/1/{{ $user->id}}" class="btn btn-danger btn-xs" title="Delete Details" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-trash"></i></a> 
                    {{--  <a href="{{url('/')}}/admin/block-user/{{ Hash::make($user->id) }}" class="btn btn-danger btn-xs" title="Block User" onclick="return confirm('Are you sure you want to Block this User?');"><i class="fa fa-ban"></i></a> --}} 
                     @endif
