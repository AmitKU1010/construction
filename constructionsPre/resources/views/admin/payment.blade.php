            ...
            <table class="table table-responsive table-bordered">
                ...
                <tbody>                  
                  ...
                  <tr>
                    ...
                    <td>
                      {{Form::text('fees_paymet_date[]', isset($fees_paymet_date) ? $fees_paymet_date : '', ['class' => 'form-control payment_datepicker', 'id' => 'datepicker_'.$paymnet['id']] )}}
                      {{Form::hidden('is_new[]', '', ['class' => 'is_new_'.$paymnet['id']])}}
                    </td>
                  </tr>
                  @php $counter ++; @endphp
                  @endforeach
